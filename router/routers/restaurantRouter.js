...
restaurantRouter.get("/restuarant/:id",authenticateUser, getRestaurantById)
restaurantRouter.post("/addrestuarant/:id",authenticateSuperAdmin, addRestaurant)
// restaurantRouter.put("/editfood/:id",updateFood)
restaurantRouter.delete("/deletrestauran/:id",adminsValidation,deleteRestaurant)


verifyRestaurantRouter.post("/verifyrestaurant",upload.single('image'),adminsValidation, addVerifyRestaurant)
verifyRestaurantRouter.get("/verifyrestaurant/all",adminsValidation,getAllVerifyRestaurants)
